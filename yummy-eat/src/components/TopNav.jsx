  ...
  return (
    <div className='max-w-[1520] mx-auto flex justify-between items-center p4'>
           ...
           <button className='bg-orange-700 text-white hidden md:flex items-center py-2 rounded-full'>
             <BsFillCartFill size={25}/> Cart</button>
          ...
          'fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-300'}>
            ...
            <nav>
              <ul className='flex-col p-4 text-gray-900 '>
                <li className='text-xl py-4 flex'>
                  <BsPerson size={25} className='mr-4 text-white bg-black rounded-full'></BsPerson> My Account
                </li>

                <li className='text-xl py-4 flex'>
                  <TbTruckReturn size={25} className='mr-4 text-white bg-black rounded-full'></TbTruckReturn> Delivery
                </li>

                <li className='text-xl py-4 flex'>
                  <MdOutlineFavorite size={25} className='mr-4 text-white bg-black rounded-full'></MdOutlineFavorite> My Favoutite
                </li>
