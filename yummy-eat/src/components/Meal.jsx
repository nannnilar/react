    ...
    <div className='max-w-[1520] m-auto px-4 py-12'>
        ...
        <div className='flex flex-col lg:flex-row justify-center m-3'>
            ...
            <button onClick={() => setFoods(mealData)} className='m-1 border-orange-700 text-white bg-orange-700 hover:bg-white hover:text-orange-700 hover:border-orange-700'>All</button>
                ...
                <button onClick={() => filterCat('noddle')} className='m-1 border-orange-700 text-white bg-orange-700 hover:bg-white hover:text-orange-700 hover:border-orange-700'>Noddle</button>
                <button onClick={() => filterCat('rice')} className='m-1 border-orange-700 text-white bg-orange-700 hover:bg-white hover:text-orange-700 hover:border-orange-700'>Rice</button>
                        ...
                        <div className='border-none hover:scale-105 duration-300' key={item.id}>
                            <img className='w-full h-[200px] object-cover rounded-lg'
                             ...
                             <div className='pl-2 py-4'>
                                <p className='flex items-center text-indigo-600'>View More<ArrowRightIcon className='w-5 ml-2 '></ArrowRightIcon></p>
                             </div>
                        </div>
                    )
                )
